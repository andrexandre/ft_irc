...
*/
static bool checkIndentation(string& line, WebServ& data, Server_block** newBlock)
{
	static int nb; 
...
*/
static bool validSpace(Server_block** newBlock, string& line)
{
	if (!(*newBlock))
	{
...
static bool endsWithConf(const string& fileName)
{
